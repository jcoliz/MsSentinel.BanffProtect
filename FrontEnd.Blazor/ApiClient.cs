...
namespace MsSentinel.BanffProtect.BackEnd.Api
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task StoreConfigAsync(ConnectorConfiguration config)
        {
            return StoreConfigAsync(config, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task StoreConfigAsync(ConnectorConfiguration config, System.Threading.CancellationToken cancellationToken)
        {
            if (config == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var json_ = System.Text.Json.JsonSerializer.SerializeToUtf8Bytes(config, JsonSerializerSettings);
    ...
    public partial class ConnectorConfiguration
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("ApplicationSecret")]
        public string ApplicationSecret { get; set; }

        [System.Text.Json.Serialization.JsonPropertyName("CollectionEndpoint")]
        public System.Uri CollectionEndpoint { get; set; }
